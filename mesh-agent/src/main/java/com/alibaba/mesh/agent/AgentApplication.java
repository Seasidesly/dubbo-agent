package com.alibaba.mesh.agent;
...
public class AgentApplication {
	...
	// 在Provider端启动agent时，添加JVM参数-Dtype=provider -Dserver.port=30000 -Ddubbo.protocol.port=20889 -Dagent.netty.port=9559 -Dweight=1
